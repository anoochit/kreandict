...
public class UpdateActivity extends Activity {
    ...
    public void moveDB() throws Exception {    	    	
    	...
    	String f2=Environment.getExternalStorageDirectory().getPath()+"/teenword.db";
    	
    	BufferedOutputStream bufEcrivain = new BufferedOutputStream((new FileOutputStream(f)));
    	BufferedInputStream VideoReader = new BufferedInputStream(new FileInputStream(f2));
...
class DownloadFileAsync extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... aurl) {
	    ...
	    OutputStream output = new FileOutputStream(Environment.getExternalStorageDirectory().getPath()+"/teenword.db");
	    
	    Log.d("DEBUG",Environment.getExternalStorageDirectory().getPath()+"/teenword.db");
